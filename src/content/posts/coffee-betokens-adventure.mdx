...
image: /hero-images/czechowice_coffee.jpg
---
import ArticleImage from '../../components/ArticleImage.astro'

import backpack from '../../assets/balkans/backpack.jpg'
import czechowiceCoffee from '../../assets/balkans/czechowice_coffee.jpg'
import budapestFerry from '../../assets/balkans/budapest_ferry.jpg'
import budapest from '../../assets/balkans/budapest_2.jpg'
...
<ArticleImage src={backpack} style={{width: '300px', margin: '0 auto'}} alt="Travel gear before and after packing." caption="Packing a backpack."/>
...
<ArticleImage src={czechowiceCoffee} alt="A night photography of a yard in front of restaurants in Polish town. Few benches and trees in the middle of the image and a railway station in the background." caption="Coffee in Czechowice-Dziedzice, Poland"/>
...
<ArticleImage src={budapestFerry} alt="A colorful ferry in the foreground stationing on main river of Budapest. Mountain and Buda castle in the background." caption="Budapest, Hungary"/>
...
<ArticleImage src={budapest} alt="A city park in Budapest. Split footbridge in water, grass and trees in the background." caption="Budapest, Hungary" />
